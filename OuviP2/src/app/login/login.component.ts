  ...
  anonym() {
    ...
    this.dataService.userlogin(user, pass)
      ...
      .subscribe(
        response => {
          if (response.success) {
            alert('AVISO: As manifestações registradas de forma anônima são consideradas "Comunicações" e não é possível o seu acompanhamento. Caso deseje acompanhar o andamento da sua manifestação e receber uma resposta do órgão ou entidade, por favor registre-se.')
